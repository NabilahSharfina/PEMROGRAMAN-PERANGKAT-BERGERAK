...
import com.nabilah_19104025.modul10.databinding.ActivityMainBinding
...
import com.nabilah_19104025.modul10.helper.REQUEST_ADD
import com.nabilah_19104025.modul10.helper.REQUEST_UPDATE
...
import com.nabilah_19104025.modul10.helper.mapCursorToArrayList
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        supportActionBar?.title = "Modul 10 - SQLite (Quotes)"
    ...
    private fun loadQuotes() {
        GlobalScope.launch(Dispatchers.Main) {
            ...
            if (quotes.size > 0) {
                ...
                showSnackbarMessage("Saat ini data kosong!")
            }
        }
    }
